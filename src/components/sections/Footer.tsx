        ...
        <div className="flex flex-col lg:flex-row justify-between items-center gap-8 relative z-10">
          ...
          >
            ...
            <p className="text-muted-foreground/40 text-[9px] uppercase tracking-[0.1em]">
              Designed and Developed by <Link to="https://emanate.global" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-primary/80 transition-all duration-300">Emanate</Link>
            </p>
          </motion.div>
