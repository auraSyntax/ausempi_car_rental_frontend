                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <Button
                      ...
                      className="border-white/10 hover:bg-white/5 hover:border-white/20 text-white/70 hover:text-white  text-[11px] font-bold uppercase tracking-[0.2em] h-14 rounded-2xl transition-all duration-300"
                    >
                      ESSENTIAL
                    </Button>
                    <Button
          ...
          <div className="relative">
            ...
            <div className="p-8 md:p-12 pt-0 flex flex-col sm:flex-row gap-4 relative">
              ...
              <Button
                variant="outline"
                onClick={handleAcceptAll}
                className="flex-1 border-white/10 hover:bg-primary/5 hover:border-primary/20 text-white hover:text-primary font-bold tracking-[0.15em] h-14 rounded-2xl transition-all duration-300"
              >
                ACCEPT ALL
              </Button>
            </div>
